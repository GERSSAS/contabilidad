                ...
                <div class="card-body">
                  <form role="form" method="POST">
                    ...
                    <div class="text-center">
                      <button type="button" class="btn bg-gradient-info w-100 mt-4 mb-0"  value="Login" onclick="validateLoginForm()"> INGRESAR </button>
                    </div>
                  </form>
                </div>
...
function validateLoginForm() {
  ...
  if (correo === '' || user_password === '') {
      ...
      Swal.fire({
          ...
          icon: 'error',
          title: 'Campos vacios',
          text: 'Ingresa un correo y una contraseña validos!',
      })
      return;
  }
}

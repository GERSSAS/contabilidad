...
<br>
<h3 style="text-align: center;">Modulo Transportes </h3>
...
<form>
    ...
    <div class="pagina">
        ...
        <div class="container table-responsive">
            ...
            <table id="TransporteTabla" class="table table-sm">
                ...
                <tbody class="table-group-divider">
                    <tr class="tr-inputs">
                        ...
                        <th>
                            <div><input class="form-control form-control-sm inputDate" id="idDateTransporte1" type="date"></div>
                        </th>
                        ...
                        <td >
                        <i id="addRowTransporte" class="bi deleteRow bi-plus-circle-fill"></i>
                        </td>

...
<div class="form-control">
                    ...
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4">
                        <h6 class="text-white text-capitalize ps-3" style="text-align: center;">RELACIÓN DE GASTOS</h6>
                    </div>
